...
export default function FishingTripsLogo({ fill }): JSX.Element {
  return (
    <Svg width={140} height={27} viewBox="0 0 226 40.6" fill="none">
      <Path
        d="M19.7,10.3v3.5H5.3c-1,0-1.8,0.8-1.8,1.8v1.8h12.6V21H3.5v9H0V15.7c0-2.9,2.4-5.3,5.3-5.3H19.7z"
        fill={fill}
      />
      <Path d="M22.4,30V10.3H26V30H22.4z" fill={fill} />
      <Path
        d="M43.8,15.8v-0.1c0-1-0.8-1.8-1.8-1.8h-8c-1,0-1.8,0.8-1.8,1.8v0.1c0,1,0.8,1.8,1.8,1.8h7.1
      ...
      />
      <Path
        d="M69.8,10.3V30h-3.5v-9H53.7v9h-3.5V10.3h3.5v7.1h12.6v-7.1H69.8z"
        fill={fill}
      />
      <Path d="M72.6,30V10.3h3.5V30H72.6z" fill={fill} />
      <Path
        d="M98.6,10.4V30l-3.5-2.7l-12.6-9.7V30H79V10.4l3.5,2.7l12.6,9.7V10.3L98.6,10.4z"
        fill={fill}
      />
      <Path
        d="M104.9,20.2c0,3.5,2.8,6.3,6.3,6.3h6.3v-3.8h-6.3v-3.5h9.8V30h-9.8c-5.4,0-9.8-4.4-9.8-9.8
        c0-5.4,4.4-9.8,9.8-9.8h9.8v3.5h-9.8C107.8,13.9,104.9,16.7,104.9,20.2z"
        fill={fill}
      />
      <Path
        d="M157.2,10.4v3.5h-8.1V30h-3.5V13.9h-8.1v-3.5H157.2z"
        fill={fill}
      />

      <Path
        d="M175.9,26.6l1.8,3.5h-3.9l-1.8-3.5l-1.9-3.7l-0.1-0.2c-0.6-1-1.7-1.7-3-1.7h-3.5v9H160V10.4h12.4
        ...
        fill={fill}
      />
      <Path d="M180.6,30V10.3h3.5V30H180.6z" fill={fill} />
      <Path
        d="M203.1,11.9c1,1,1.5,2.3,1.5,3.8c0,2.1-1.3,4-3.1,4.8c-0.5,0.2-1,0.4-1.5,0.4c-0.1,0-0.1,0-0.2,0v0h-9.4v9
      ...
      />
      <Path
        d="M222.5,15.8v-0.1c0-1-0.8-1.8-1.8-1.8h-8c-1,0-1.8,0.8-1.8,1.8v0.1c0,1,0.8,1.8,1.8,1.8h7.1
